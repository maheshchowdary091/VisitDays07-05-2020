...
class ConfirmationPage {
	...
	def RegistrationOfACombinationOfRequestAndInstant(String RequestVisitType, String InstantVisitType, TestObject VisitTypeCategory, String NumberOfRequests) {
		...
		Object1.addProperty("xpath",ConditionType.EQUALS, "//strong[text()='"+InstantVisitType+"']/../../../..//button[@class=' mobi-daily-visit--hours-item']")
		...
		object.addProperty("xpath", ConditionType.EQUALS, "//strong[text()='"+RequestVisitType+"']/../../../..//button[text()='Add to My Itinerary']")
		...
		driver.findElement(By.xpath(('//strong[text()=\'' + RequestVisitType) + '\']/../../../..//button[text()=\'Added\']')).isDisplayed()
	...
	def NavgateToConfirmationPageForIndividualRegistrationOfInstantVisitForTomorrow(String VisitType, TestObject VisitTypeCategory, String NumberOfRequests) {
		...
		Object.addProperty("xpath",ConditionType.EQUALS, "//strong[text()='"+VisitType+"']/../../../..//button[@class=' mobi-daily-visit--hours-item']")
...
//		}
	...
	def NavgateToConfirmationPageForGroupRequestWithUserName(String VisitType, TestObject VisitTypeCategory, String NumberOfRequests)
	{
		...
		object12.addProperty("xpath", ConditionType.EQUALS,"//strong[text()='"+VisitType+"']/../../../..//button[text()='Add to My Itinerary']")
...
//		}
	...
	def NavgateToConfirmationPageForGroupRequestWithUserNameForInstantBook(String VisitType, TestObject VisitTypeCategory, String NumberOfRequests)
	{
		...
		Object1.addProperty("xpath",ConditionType.EQUALS, "//strong[text()='"+VisitType+"']/../../../..//button[@class=' mobi-daily-visit--hours-item']")
