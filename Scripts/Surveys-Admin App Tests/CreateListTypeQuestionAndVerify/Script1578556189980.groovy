...
CustomKeywords.'com.CommonUtilities.SurveyMethods.goToSurveyQuestionsPage'()

//WebUI.delay(50)

def questionName = CustomKeywords.'com.CommonUtilities.AddQuestion.getRandomQuestionName'()

CustomKeywords.'com.CommonUtilities.SurveyMethods.clickAddQuestioButton'()

CustomKeywords.'com.CommonUtilities.SurveyMethods.enterQuestionName'(questionName)

CustomKeywords.'com.CommonUtilities.SurveyMethods.selectQuestionType'("List")

CustomKeywords.'com.CommonUtilities.SurveyMethods.enterDataInChoices'("1")

CustomKeywords.'com.CommonUtilities.SurveyMethods.enterDataInChoices'("2")

//CustomKeywords.'com.CommonUtilities.SurveyMethods.selectAudience'()

CustomKeywords.'com.CommonUtilities.SurveyMethods.selectVisitTypeRadioButton'("specific")

CustomKeywords.'com.CommonUtilities.SurveyMethods.selectSpecificVisitType'([visitType])
...
CustomKeywords.'com.CommonUtilities.SurveyMethods.verifyQuestionPresentInSurvey'(questionName)
