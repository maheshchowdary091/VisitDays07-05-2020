...
CustomKeywords.'com.CommonUtilities.CreationOperations.CreateDailyVisitWithRequestVisitTypeForFutureDates'(VisitType)

def CurrentUrl = WebUI.getUrl()

WebUI.navigateToUrl(GlobalVariable.EvrUrl)

def StudentName = CustomKeywords.'com.CommonUtilities.ConfirmationPage.CompleteRegistration'([VisitType], findTestObject('Object Repository/Add Attendee/DailyVisitsOptionInAddAttendee'))
