...
String TimeInSummaryPage = WebUI.getText(findTestObject('OffCampusPage/TimeInTimesDivisionForOffCampus'))

String ActualTimeZoneBeforeEdit = TimeInSummaryPage.split("09:00 AM ")[1]
...
if (!(WebUI.verifyMatch((DateInSummaryPage.split(',')[0]) + ', '+'8:00 AM '+ActualTimeZoneBeforeEdit+' - 9:00 AM '+ActualTimeZoneBeforeEdit, DateAndTime, false))) {
	WebUI.takeScreenshot()
