...
WebUI.verifyElementPresent(findTestObject('Add Attendee/DoYouWantToContinueWarningMessageWhileClosingMobi'), 0)

WebUI.verifyElementPresent(findTestObject('Add Attendee/ContinueButtonInExitConfirmationPopupInMobi'), 0)

WebUI.verifyElementPresent(findTestObject('Add Attendee/QuitButtonInExitConfirmationPopupInMobi'), 0)
