...
String RequestVisitType1 = CustomKeywords.'com.CommonUtilities.RequestMethods.CreateRequestEventVisitType'()

CustomKeywords.'com.CommonUtilities.CreateVisitWithDifferentStatuses.CreateEventWithRequestVisitTypeWithFutureTimes'(RequestVisitType1)

String RequestVisitType2 = CustomKeywords.'com.CommonUtilities.RequestMethods.CreateRequestEventVisitType'()

CustomKeywords.'com.CommonUtilities.CreateVisitWithDifferentStatuses.CreateEventWithRequestVisitTypeWithFutureTimes'(RequestVisitType2)
