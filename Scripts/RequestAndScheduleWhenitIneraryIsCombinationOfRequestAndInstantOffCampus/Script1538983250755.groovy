...
CustomKeywords.'com.CommonUtilities.CreationOperations.CreateOffCampusWithRequestVisitType'(RequestVisitType)
...
CustomKeywords.'com.CommonUtilities.CreationOperations.CreateOffCampusWithInstantVisitType'(InstantVisitType)
...
String IndividualStudent = CustomKeywords.'com.CommonUtilities.ConfirmationPage.RegistrationOfACombinationOfRequestAndInstant'(
		RequestVisitType, InstantVisitType, findTestObject('Add Attendee/OffCampusOptionInAddAttendee'), Single)
...
{
	KeywordUtil.markFailed("After scheduling the Off-Campus request the visit is not shown in the pendig tab")
