...
CustomKeywords.'com.CommonUtilities.CreationOperations.CreateInstantOffCampusVisitByAssigningUsers'(OffCampusVisitVisitType)
...
object.addProperty('xpath', ConditionType.EQUALS, ('//strong[text()=\'' + OffCampusVisitVisitType) + '\']')

WebUI.scrollToElement(object, 0)

WebUI.click(object)

WebUI.verifyElementText(findTestObject('Add Attendee/VisitNameInVisitDescriptionInMobi'), OffCampusVisitVisitType)
...
if (!(WebUI.verifyElementPresent(findTestObject('Add Attendee/WhoYouWillMeetUserProfile'), 0, FailureHandling.OPTIONAL))) {
	KeywordUtil.markFailed('Who You Will Meet Admin profile is not shown for Off-Campus visits')
