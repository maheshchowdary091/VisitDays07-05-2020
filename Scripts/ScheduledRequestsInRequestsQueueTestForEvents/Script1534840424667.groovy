...
driver.findElement(By.xpath(('//h3[text()=\'' + EventVisitType) + '\']/..//span[text()=\'Schedule\']')).click()
...
//CustomKeywords.'com.CommonUtilities.NavigationFlows.NavigateToRequestQueue'()
//
////WebUI.waitForElementNotPresent(findTestObject('Requests/ScheduleRequestHeaderInRequestScheduleModal'), 0)
////
////WebUI.verifyElementNotPresent(findTestObject('Requests/ScheduleRequestHeaderInRequestScheduleModal'), 0)
//
