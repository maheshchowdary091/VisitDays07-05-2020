...
not_run: CustomKeywords.'com.CommonUtilities.AddVisitorDirectlyToTheVisit.AddGroupDirectlyToAVisit'()
...
CustomKeywords.'com.CommonUtilities.Verifications.VerifyTextMatch'(TextOnRegisteredTab, '(2)', 'When added an inddividual directly to a scheduled (request) visit then the count on the Registered tab is shown in correct, Expected count: 2, Actual count: ' +
		TextOnRegisteredTab)
