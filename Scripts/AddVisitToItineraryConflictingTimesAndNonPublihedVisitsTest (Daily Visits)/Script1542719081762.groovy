...
{
	WebUI.waitForElementVisible(findTestObject('Object Repository/DailyVisitsPage/CloseButtonInAddVisitToItineraryEmptystateModal'), 0)
...
CustomKeywords.'com.CommonUtilities.CreateVisitWithDifferentStatuses.CreateDailyVisitWithFutureTimes'(InstantVisitType)
